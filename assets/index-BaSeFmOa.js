...
void main() {
	...
	if ( coord.x >= 1.0 ) {
      ...
      `})]})},aR=()=>{const s=["3D Modeling","Character Design","Character Rigging","Texturing","3D Animation"];return b.jsxs("section",{id:"works",className:"w-full h-screen bg-gray-100 flex flex-col overflow-hidden sticky top-0",style:{backgroundColor:"#f5f5f5",zIndex:1},children:[b.jsx("header",{className:"flex justify-between items-center px-8 py-6 border-b border-gray-300",children:b.jsx("div",{className:"flex items-center gap-4",children:b.jsx("h2",{className:"text-sm font-medium tracking-wider jetbrains",style:{color:"#212121"},children:"FEATURED WORK 01"})})}),b.jsxs("div",{className:"flex-1 flex flex-col p-8",children:[b.jsxs("div",{className:"hidden lg:flex flex-col flex-1",children:[b.jsxs("div",{className:"flex justify-between items-start mb-6",children:[b.jsx("div",{className:"flex-1",children:b.jsxs("h1",{className:"text-4xl md:text-5xl font-light leading-tight",style:{color:"#212121"},children:["Sanrio: Character &",b.jsx("br",{}),"Company page"]})}),b.jsxs("div",{className:"text-right ml-8 flex flex-col items-end",children:[b.jsx("div",{className:"text-xl font-medium mb-2 jetbrains",style:{color:"#212121"},children:"2025"}),b.jsx("div",{className:"text-xs tracking-wider uppercase jetbrains mb-4",style:{color:"#212121"},children:"~ TECH WORKS"}),b.jsx("div",{className:"bg-gray-200 rounded-sm p-3 w-80 overflow-hidden",children:b.jsx("div",{className:"flex animate-scroll whitespace-nowrap",children:[...Array(3)].map((e,n)=>b.jsx("div",{className:"flex gap-8 mr-8",children:s.map((a,l)=>b.jsx("span",{className:"text-xs jetbrains",style:{color:"#212121"},children:a},`${n}-${l}`))},n))})})]})]}),b.jsx("div",{className:"border-b border-dashed border-gray-400 mb-6"}),b.jsxs("div",{className:"flex gap-8 flex-1",children:[b.jsxs("div",{className:"w-80 flex flex-col justify-start",children:[b.jsx("p",{className:"text-xs leading-relaxed mb-6 jetbrains uppercase",style:{color:"#212121"},children:"Whimsical animations bring each character to life, revealing their profiles, personalities, and merchandise. The project is defined by its soft pastel design and fluid motion, presented as a heartfelt, fan-page-style portfolio that showcases a genuine passion for the characters."}),b.jsxs("a",{href:"https://yoon664.github.io/sanrio_po/",target:"_blank",rel:"noopener noreferrer",className:"relative group overflow-hidden px-4 py-2 text-xs font-medium tracking-wider uppercase jetbrains inline-block bg-black text-white hover:text-black transition-colors duration-400 ease-out",children:[b.jsx("div",{className:"absolute bottom-0 left-0 right-0 h-0 bg-white transition-all duration-400 ease-out group-hover:h-full z-0"}),b.jsxs("span",{className:"relative flex items-center gap-2 z-10",children:["VIEW PROJECT",b.jsx("span",{className:"transform group-hover:translate-x-1 transition-transform duration-300",children:"→"})]})]})]}),b.jsx("div",{className:"flex-1",children:b.jsx("div",{className:"rounded-sm overflow-hidden h-full",children:b.jsx("img",{src:"img/sanrio1.png",alt:"Sanrio main",className:"w-full h-full object-cover"})})}),b.jsxs("div",{className:"w-80 flex flex-col gap-4",children:[b.jsx("div",{className:"flex-1 rounded-sm overflow-hidden",children:b.jsx("video",{src:"img/sanrio2.mp4",autoPlay:!0,loop:!0,muted:!0,playsInline:!0,className:"w-full h-full object-cover"})}),b.jsx("div",{className:"flex-1 rounded-sm overflow-hidden",children:b.jsx("img",{src:"img/sanrio3.png",alt:"Sanrio detail",className:"w-full h-full object-cover"})})]})]})]}),b.jsxs("div",{className:"lg:hidden flex flex-col flex-1",children:[b.jsxs("h1",{className:"text-3xl font-light leading-tight mb-4",style:{color:"#212121"},children:["Sanrio: Character &",b.jsx("br",{}),"Company page"]}),b.jsxs("div",{className:"flex justify-between items-center mb-4",children:[b.jsxs("div",{children:[b.jsx("div",{className:"text-lg font-medium jetbrains",style:{color:"#212121"},children:"2025"}),b.jsx("div",{className:"text-xs tracking-wider uppercase jetbrains",style:{color:"#212121"},children:"~ TECH WORKS"})]}),b.jsxs("a",{href:"https://yoon664.github.io/sanrio_po/",target:"_blank",rel:"noopener noreferrer",className:"relative group overflow-hidden px-4 py-2 text-xs font-medium tracking-wider uppercase jetbrains inline-block bg-black text-white hover:text-black transition-colors duration-400 ease-out",children:[b.jsx("div",{className:"absolute bottom-0 left-0 right-0 h-0 bg-white transition-all duration-400 ease-out group-hover:h-full z-0"}),b.jsxs("span",{className:"relative flex items-center gap-2 z-10",children:["VIEW PROJECT",b.jsx("span",{className:"transform group-hover:translate-x-1 transition-transform duration-300",children:"→"})]})]})]}),b.jsx("div",{className:"border-b border-dashed border-gray-400 mb-4"}),b.jsx("div",{className:"mb-4",children:b.jsx("img",{src:"/img/sanrio1.png",alt:"Sanrio main",className:"w-full h-auto object-cover rounded-sm"})}),b.jsx("p",{className:"text-xs leading-relaxed jetbrains uppercase",style:{color:"#212121"},children:"Whimsical animations bring each character to life, revealing their profiles, personalities, and merchandise. The project is defined by its soft pastel design and fluid motion, presented as a heartfelt, fan-page-style portfolio that showcases a genuine passion for the characters."})]})]}),b.jsx("style",{jsx:!0,children:`
        @keyframes scroll {
          0% {
      ...
      `})]})},rR=()=>{const s=["3D Modeling","Character Design","Character Rigging","Texturing","3D Animation"];return b.jsxs("section",{id:"works2",className:"w-full h-screen bg-gray-100 flex flex-col overflow-hidden sticky top-0",style:{backgroundColor:"#008761",zIndex:2},children:[b.jsx("header",{className:"flex justify-between items-center px-8 py-6 border-b border-gray-300",children:b.jsx("div",{className:"flex items-center gap-4",children:b.jsx("h2",{className:"text-sm font-medium tracking-wider jetbrains",style:{color:"#ffffff"},children:"FEATURED WORK 02"})})}),b.jsxs("div",{className:"flex-1 flex flex-col p-8",children:[b.jsxs("div",{className:"hidden lg:flex flex-col flex-1",children:[b.jsxs("div",{className:"flex justify-between items-start mb-6",children:[b.jsx("div",{className:"flex-1",children:b.jsxs("h1",{className:"text-4xl md:text-5xl font-light leading-tight",style:{color:"#ffffff"},children:["Amio",b.jsx("br",{}),"Pulmuone amio"]})}),b.jsxs("div",{className:"text-right ml-8 flex flex-col items-end",children:[b.jsx("div",{className:"text-xl font-medium mb-2 jetbrains",style:{color:"#ffffff"},children:"2025"}),b.jsx("div",{className:"text-xs tracking-wider uppercase jetbrains mb-4",style:{color:"#ffffff"},children:"~ TECH WORKS"}),b.jsx("div",{className:"bg-gray-200 rounded-sm p-3 w-80 overflow-hidden",children:b.jsx("div",{className:"flex animate-scroll whitespace-nowrap",children:[...Array(3)].map((e,n)=>b.jsx("div",{className:"flex gap-8 mr-8",children:s.map((a,l)=>b.jsx("span",{className:"text-xs jetbrains",style:{color:"#212121"},children:a},`${n}-${l}`))},n))})})]})]}),b.jsx("div",{className:"border-b border-dashed border-gray-400 mb-6"}),b.jsxs("div",{className:"flex gap-8 flex-1",children:[b.jsxs("div",{className:"w-80 flex flex-col justify-start",children:[b.jsx("p",{className:"text-xs leading-relaxed mb-6 jetbrains uppercase",style:{color:"#ffffff"},children:"brand website for the premium pet food brand Amio. The site features an interactive design where content dynamically appears as users scroll, allowing them to explore the brand story, product lineup, and unique ingredients in an engaging and immersive way."}),b.jsxs("a",{href:"https://yoon664.github.io/amio/",target:"_blank",rel:"noopener noreferrer",className:"relative group overflow-hidden px-4 py-2 text-xs font-medium tracking-wider uppercase jetbrains inline-block bg-black text-white hover:text-black transition-colors duration-400 ease-out",children:[b.jsx("div",{className:"absolute bottom-0 left-0 right-0 h-0 bg-white transition-all duration-400 ease-out group-hover:h-full z-0"}),b.jsxs("span",{className:"relative flex items-center gap-2 z-10",children:["VIEW PROJECT",b.jsx("span",{className:"transform group-hover:translate-x-1 transition-transform duration-300",children:"→"})]})]})]}),b.jsx("div",{className:"flex-1",children:b.jsx("div",{className:"rounded-sm overflow-hidden h-full",children:b.jsx("video",{src:"img/amio1.mp4",autoPlay:!0,loop:!0,muted:!0,playsInline:!0,className:"w-full h-full object-cover"})})}),b.jsxs("div",{className:"w-80 flex flex-col gap-4",children:[b.jsx("div",{className:"flex-1 rounded-sm overflow-hidden",children:b.jsx("video",{src:"img/amio3.mp4",autoPlay:!0,loop:!0,muted:!0,playsInline:!0,className:"w-full h-full object-cover"})}),b.jsx("div",{className:"flex-1 rounded-sm overflow-hidden",children:b.jsx("video",{src:"img/amio2.mp4",autoPlay:!0,loop:!0,muted:!0,playsInline:!0,className:"w-full h-full object-cover"})})]})]})]}),b.jsxs("div",{className:"lg:hidden flex flex-col flex-1",children:[b.jsxs("h1",{className:"text-3xl font-light leading-tight mb-4",style:{color:"#ffffff"},children:["Amio",b.jsx("br",{}),"Pulmuone amio"]}),b.jsxs("div",{className:"flex justify-between items-center mb-4",children:[b.jsxs("div",{children:[b.jsx("div",{className:"text-lg font-medium jetbrains",style:{color:"#ffffff"},children:"2025"}),b.jsx("div",{className:"text-xs tracking-wider uppercase jetbrains",style:{color:"#ffffff"},children:"~ TECH WORKS"})]}),b.jsxs("a",{href:"https://yoon664.github.io/amio/",target:"_blank",rel:"noopener noreferrer",className:"relative group overflow-hidden px-4 py-2 text-xs font-medium tracking-wider uppercase jetbrains inline-block bg-black text-white hover:text-black transition-colors duration-400 ease-out",children:[b.jsx("div",{className:"absolute bottom-0 left-0 right-0 h-0 bg-white transition-all duration-400 ease-out group-hover:h-full z-0"}),b.jsxs("span",{className:"relative flex items-center gap-2 z-10",children:["VIEW PROJECT",b.jsx("span",{className:"transform group-hover:translate-x-1 transition-transform duration-300",children:"→"})]})]})]}),b.jsx("div",{className:"border-b border-dashed border-gray-400 mb-4"}),b.jsx("div",{className:"mb-4",children:b.jsx("video",{src:"/img/amio1.mp4",autoPlay:!0,loop:!0,muted:!0,playsInline:!0,className:"w-full h-auto object-cover rounded-sm"})}),b.jsx("p",{className:"text-xs leading-relaxed jetbrains uppercase",style:{color:"#ffffff"},children:"brand website for the premium pet food brand Amio. The site features an interactive design where content dynamically appears as users scroll, allowing them to explore the brand story, product lineup, and unique ingredients in an engaging and immersive way."})]})]}),b.jsx("style",{jsx:!0,children:`
        @keyframes scroll {
          0% {
            transform: translateX(0);
          }
      ...
      `})]})},sR=()=>{const s=["3D Modeling","Character Design","Character Rigging","Texturing","3D Animation"];return b.jsxs("section",{id:"works3",className:"w-full h-screen bg-gray-100 flex flex-col overflow-hidden sticky top-0",style:{backgroundColor:"#DE7439",zIndex:3},children:[b.jsx("header",{className:"flex justify-between items-center px-8 py-6 border-b border-gray-300",children:b.jsx("div",{className:"flex items-center gap-4",children:b.jsx("h2",{className:"text-sm font-medium tracking-wider jetbrains",style:{color:"#212121"},children:"FEATURED WORK 03"})})}),b.jsxs("div",{className:"flex-1 flex flex-col p-8",children:[b.jsxs("div",{className:"hidden lg:flex flex-col flex-1",children:[b.jsxs("div",{className:"flex justify-between items-start mb-6",children:[b.jsx("div",{className:"flex-1",children:b.jsxs("h1",{className:"text-4xl md:text-5xl font-light leading-tight",style:{color:"#212121"},children:["Hanhwa",b.jsx("br",{}),"Company & History"]})}),b.jsxs("div",{className:"text-right ml-8 flex flex-col items-end",children:[b.jsx("div",{className:"text-xl font-medium mb-2 jetbrains",style:{color:"#212121"},children:"2025"}),b.jsx("div",{className:"text-xs tracking-wider uppercase jetbrains mb-4",style:{color:"#212121"},children:"~ TECH WORKS"}),b.jsx("div",{className:"bg-gray-200 rounded-sm p-3 w-80 overflow-hidden",children:b.jsx("div",{className:"flex animate-scroll whitespace-nowrap",children:[...Array(3)].map((e,n)=>b.jsx("div",{className:"flex gap-8 mr-8",children:s.map((a,l)=>b.jsx("span",{className:"text-xs jetbrains",style:{color:"#212121"},children:a},`${n}-${l}`))},n))})})]})]}),b.jsx("div",{className:"border-b border-dashed border-gray-400 mb-6"}),b.jsxs("div",{className:"flex gap-8 flex-1",children:[b.jsxs("div",{className:"w-80 flex flex-col justify-start",children:[b.jsx("p",{className:"text-xs leading-relaxed mb-6 jetbrains uppercase",style:{color:"#212121"},children:"A dynamic website created to showcase the rich history and brand identity of the Hanhwa Eagles. The site utilizes scroll-based animations and a clean, modern interface to guide users through the team's significant milestones and evolution in an engaging narrative format."}),b.jsxs("a",{href:"https://yoon664.github.io/han-eagle/",target:"_blank",rel:"noopener noreferrer",className:"relative group overflow-hidden px-4 py-2 text-xs font-medium tracking-wider uppercase jetbrains inline-block bg-black text-white hover:text-black transition-colors duration-400 ease-out",children:[b.jsx("div",{className:"absolute bottom-0 left-0 right-0 h-0 bg-white transition-all duration-400 ease-out group-hover:h-full z-0"}),b.jsxs("span",{className:"relative flex items-center gap-2 z-10",children:["VIEW PROJECT",b.jsx("span",{className:"transform group-hover:translate-x-1 transition-transform duration-300",children:"→"})]})]})]}),b.jsx("div",{className:"flex-1",children:b.jsx("div",{className:"rounded-sm overflow-hidden h-full",children:b.jsx("img",{src:"img/hanhwa.png",alt:"Hanhwa main",className:"w-full h-full object-cover"})})}),b.jsxs("div",{className:"w-80 flex flex-col gap-4",children:[b.jsx("div",{className:"flex-1 rounded-sm overflow-hidden",children:b.jsx("video",{src:"img/hanhwa3.mp4",autoPlay:!0,loop:!0,muted:!0,playsInline:!0,className:"w-full h-full object-cover"})}),b.jsx("div",{className:"flex-1 rounded-sm overflow-hidden",children:b.jsx("video",{src:"img/hanhwa2.mp4",autoPlay:!0,loop:!0,muted:!0,playsInline:!0,className:"w-full h-full object-cover"})})]})]})]}),b.jsxs("div",{className:"lg:hidden flex flex-col flex-1",children:[b.jsxs("h1",{className:"text-3xl font-light leading-tight mb-4",style:{color:"#212121"},children:["Hanhwa",b.jsx("br",{}),"Company & History"]}),b.jsxs("div",{className:"flex justify-between items-center mb-4",children:[b.jsxs("div",{children:[b.jsx("div",{className:"text-lg font-medium jetbrains",style:{color:"#212121"},children:"2025"}),b.jsx("div",{className:"text-xs tracking-wider uppercase jetbrains",style:{color:"#212121"},children:"~ TECH WORKS"})]}),b.jsxs("a",{href:"https://yoon664.github.io/han-eagle/",target:"_blank",rel:"noopener noreferrer",className:"relative group overflow-hidden px-4 py-2 text-xs font-medium tracking-wider uppercase jetbrains inline-block bg-black text-white hover:text-black transition-colors duration-400 ease-out",children:[b.jsx("div",{className:"absolute bottom-0 left-0 right-0 h-0 bg-white transition-all duration-400 ease-out group-hover:h-full z-0"}),b.jsxs("span",{className:"relative flex items-center gap-2 z-10",children:["VIEW PROJECT",b.jsx("span",{className:"transform group-hover:translate-x-1 transition-transform duration-300",children:"→"})]})]})]}),b.jsx("div",{className:"border-b border-dashed border-gray-400 mb-4"}),b.jsx("div",{className:"mb-4",children:b.jsx("img",{src:"/img/hanhwa.png",alt:"Hanhwa main",className:"w-full h-auto object-cover rounded-sm"})}),b.jsx("p",{className:"text-xs leading-relaxed jetbrains uppercase",style:{color:"#212121"},children:"A dynamic website created to showcase the rich history and brand identity of the Hanhwa Eagles. The site utilizes scroll-based animations and a clean, modern interface to guide users through the team's significant milestones and evolution in an engaging narrative format."})]})]}),b.jsx("style",{jsx:!0,children:`
        @keyframes scroll {
          0% {
            transform: translateX(0);
          }
      ...
      `})]})},oR=({project:s,onClose:e})=>s?b.jsxs("div",{className:"fixed inset-0 bg-white z-50 flex items-center justify-center p-16 animate-fade-in",children:[b.jsx("div",{className:"absolute top-8 right-8",children:b.jsxs("button",{onClick:e,className:"relative group overflow-hidden px-4 py-2 text-sm jetbrains uppercase tracking-wider text-gray-500",children:[b.jsx("span",{className:"block",children:"Close"}),b.jsx("div",{className:"absolute bottom-0 left-0 right-0 h-0 bg-black text-white overflow-hidden transition-all duration-300 ease-out group-hover:h-full",children:b.jsx("span",{className:"absolute bottom-0 left-0 right-0 block px-4 py-2",children:"Close"})})]})}),b.jsxs("div",{className:"w-full h-full flex items-center gap-16",children:[b.jsxs("div",{className:"w-1/2 h-full flex flex-col justify-between py-8",children:[b.jsx("div",{children:b.jsx("h1",{className:"text-9xl font-thin text-gray-800",children:s.id})}),b.jsxs("div",{className:"text-gray-800 jetbrains",children:[b.jsx("p",{className:"text-sm uppercase",children:s.title}),b.jsx("p",{className:"text-sm",children:s.year}),b.jsx("p",{className:"text-sm mt-4 max-w-md uppercase",children:s.description})]})]}),b.jsx("div",{className:"w-1/2 h-full flex items-center justify-center p-4",children:b.jsx("div",{className:"w-full aspect-square relative",children:b.jsx("img",{src:s.image,alt:s.title,className:"w-full h-full object-contain"})})})]})]}):null,lR=()=>{const s=[{id:"01",image:"img/san8.png",title:"Pumpkin Pie",year:"2024",description:"Modeling and texturing with faux oil painting texture using a bump map in Autodesk Maya."},{id:"02",image:"img/san9.png",title:"Design System",year:"2024",description:"A comprehensive design system for a fictional brand, including typography, color palette, and component library."},{id:"03",image:"img/null.jpg",title:"Editorial Spread",year:"2023",description:"A two-page magazine spread focusing on dynamic layout and typography."},{id:"04",image:"img/piku.png",title:"Mobile App UI",year:"2024",description:"User interface design for a productivity mobile application."},{id:"05",image:"img/miro.png",title:"Brand Identity",year:"2023",description:"Complete brand identity design for a local coffee shop."},{id:"06",image:"img/null.jpg",title:"3D Vector Illustration",year:"2025",description:"3d vector img"},{id:"07",image:"img/ill2.png",title:"3D Vector Illustration",year:"2025",description:"3d vector img"},{id:"08",image:"img/ill3.png",title:"3D Vector Illustration",year:"2025",description:"3d vector img"},{id:"09",image:"img/ill4.png",title:"3D Vector Illustration",year:"2025",description:"3d vector img"},{id:"10",image:"img/amio5.png",title:"Packaging Design",year:"2024",description:"Product packaging design for a line of organic snacks."},{id:"11",image:"img/ill5.png",title:"Pixel art",year:"2025",description:"A landscape digital painting created in Procreate."},{id:"12",image:"img/null.jpg",title:"Pixel art",year:"2025",description:"Graphic design for a limited edition t-shirt."},{id:"13",image:"img/ill7.png",title:"Infographic",year:"2024",description:"Data visualization and infographic design on environmental statistics."},{id:"14",image:"img/pig.png",title:"3D Model",year:"2023",description:"A low-poly 3D model of a stylized animal character."},{id:"15",image:"img/null.jpg",title:"Product Photography",year:"2024",description:"Studio photography for a luxury watch brand."},{id:"16",image:"img/pho2.png",title:"Portrait Photography",year:"2023",description:"A series of black and white portraits."},{id:"17",image:"img/null.jpg",title:"Architectural Photography",year:"2022",description:"Capturing the details of modern architecture."},{id:"18",image:"img/pho3.png",title:"Digital Artwork",year:"2024",description:"Digital Artwork used by photoshap"},{id:"19",image:"img/clean1.png",title:"Website Redesign",year:"2023",description:"A complete UX/UI redesign for an e-commerce website."},{id:"20",image:"img/clean2.png",title:"Landing Page",year:"2024",description:"Design and development of a high-conversion landing page."},{id:"21",image:"img/ill6.png",title:"Pixel art",year:"2025",description:"An animated logo reveal for a tech startup."},{id:"22",image:"img/ill1.png",title:"3D Vector Illustration",year:"2025",description:"3d vector img"},{id:"23",image:"img/pho1.png",title:"Book Cover Design",year:"2022",description:"Cover design for a fantasy novel."},{id:"24",image:"img/null.jpg",title:"Abstract Photography",year:"2024",description:"Exploring textures and light through abstract photography."}],[e,n]=Zt.useState(null),a=c=>{c.image.includes("null.jpg")||n(c)},l=()=>{n(null)};return b.jsxs(b.Fragment,{children:[b.jsxs("section",{id:"projects",className:"w-full min-h-screen bg-white flex flex-col overflow-hidden",style:{backgroundColor:"#ffffff"},children:[b.jsxs("header",{className:"flex flex-col md:flex-row md:justify-between items-start p-8 pb-6",children:[b.jsxs("div",{className:"mb-1 md:mb-0",children:[b.jsx("h1",{className:"text-5xl md:text-6xl font-light mb-4 md:mb-0",style:{color:"#212121"},children:"Archive"}),b.jsxs("p",{className:"text-sm jetbrains uppercase tracking-wide leading-relaxed md:hidden",style:{color:"#212121"},children:["A CURATED STASH OF PLAYFUL, BITE-SIZED CREATIONS",b.jsx("br",{}),"TOO SMALL FOR A PROJECT, BUT TOO GOOD TO KEEP HIDDEN."]})]}),b.jsx("div",{className:"hidden md:block max-w-md text-left",children:b.jsxs("p",{className:"text-sm jetbrains uppercase tracking-wide leading-relaxed",style:{color:"#212121"},children:["A CURATED STASH OF PLAYFUL, BITE-SIZED CREATIONS",b.jsx("br",{}),"TOO SMALL FOR A PROJECT, BUT TOO GOOD TO KEEP HIDDEN."]})})]}),b.jsxs("div",{className:"flex-1",children:[b.jsx("div",{className:"lg:hidden border-t border-dashed border-gray-400",children:b.jsx("div",{className:"grid grid-cols-3",children:s.slice(0,12).map(c=>b.jsxs("div",{className:`relative overflow-hidden group p-4 border-r border-b border-dashed border-gray-400 ${!c.image.includes("null.jpg")&&"cursor-pointer"}`,onClick:()=>a(c),tabIndex:0,children:[b.jsx("div",{className:"absolute top-3 left-3 z-10 bg-white px-0.5 py-0.5",children:b.jsx("span",{className:"text-xs jetbrains",style:{color:"#212121"},children:c.id})}),b.jsx("div",{className:"w-full h-full aspect-square",children:b.jsx("img",{src:c.image,alt:c.title,className:"w-full h-full object-cover group-hover:rotate-2 transition-transform duration-300"})}),b.jsx("div",{className:"absolute inset-0 bg-black bg-opacity-0 group-hover:bg-opacity-10 transition-all duration-300"})]},c.id))})}),b.jsx("div",{className:"hidden lg:block border-t border-dashed border-gray-400",children:b.jsx("div",{className:"grid grid-cols-8",children:s.map(c=>b.jsxs("div",{className:`relative overflow-hidden group p-4 border-r border-b border-dashed border-gray-400 ${!c.image.includes("null.jpg")&&"cursor-pointer"}`,onClick:()=>a(c),tabIndex:0,children:[b.jsx("div",{className:"absolute top-3 left-3 z-10 bg-white px-0.5 py-0.5",children:b.jsx("span",{className:"text-xs jetbrains",style:{color:"#212121"},children:c.id})}),b.jsx("div",{className:"w-full h-full aspect-square",children:b.jsx("img",{src:c.image,alt:c.title,className:"w-full h-full object-cover group-hover:rotate-2 transition-transform duration-300"})}),b.jsx("div",{className:"absolute inset-0 bg-black bg-opacity-0 group-hover:bg-opacity-10 transition-all duration-300"})]},c.id))})})]})]}),e&&b.jsx(oR,{project:e,onClose:l})]})},cR=()=>{const s=Zt.useRef(null),e=Zt.useRef(null),n=Zt.useRef(null),a=Zt.useRef(null),l=Zt.useRef(null);Zt.useEffect(()=>{if(!s.current)return;const p=new Tv,g=new zn(75,1,.1,1e3);n.current=g;const _=new Vv({canvas:s.current,alpha:!0,antialias:!0});e.current=_,_.setPixelRatio(Math.min(window.devicePixelRatio,2)),_.setClearColor(0,0),_.outputColorSpace=jn;const v=async()=>{try{const{GLTFLoader:L}=await nv(async()=>{const{GLTFLoader:B}=await import("./GLTFLoader-1hqbX91T.js");return{GLTFLoader:B}},[]);new L().load("models/geometry_effect/scene.gltf",B=>{const H=B.scene;a.current=H;const k=new zi().setFromObject(H),Y=k.getSize(new K);l.current=Math.max(Y.x,Y.y,Y.z);const N=k.getCenter(new K);H.position.sub(N),p.add(H),M()})}catch(L){console.error("GLTFLoader import 실패:",L)}},y=new Ov(16777215,6);p.add(y);const E=new Kc(16777215,8);E.position.set(10,10,10),p.add(E);const R=new Kc(16777215,4);R.position.set(-10,-10,-10),p.add(R),g.position.set(0,0,10),v();const M=()=>{const L=s.current;if(!e.current||!n.current||!L.parentElement)return;const D=L.parentElement,B=D.clientWidth,H=D.clientHeight;if(_.setSize(B,H),g.aspect=B/H,g.updateProjectionMatrix(),a.current&&l.current>0){const k=a.current,Y=l.current,C=(window.innerWidth<768?9:15)/Y;k.scale.setScalar(C)}};let x;const z=()=>{x=requestAnimationFrame(z),a.current&&(a.current.rotation.y+=.005),e.current&&p&&n.current&&e.current.render(p,n.current)};return window.addEventListener("resize",M),M(),z(),()=>{window.removeEventListener("resize",M),cancelAnimationFrame(x),e.current&&e.current.dispose()}},[]);const c=[{id:"01",name:"Motion Design"},{id:"02",name:"Brand Design"},{id:"03",name:"Editorial Design"}],f=[{id:"04",name:"Photography"},{id:"05",name:"Illustration"},{id:"06",name:"3D Tech"}],h=({id:p,name:g})=>b.jsxs("a",{className:"group block hover:opacity-80 transition-opacity",children:[" ",b.jsxs("div",{className:"flex items-center gap-3",children:[" ",b.jsx("p",{className:"text-white text-sm font-mono uppercase tracking-normal leading-6 opacity-60",children:p})," ",b.jsx("h2",{className:"text-white text-3xl md:text-4xl lg:text-5xl font-light leading-tight tracking-normal",children:g})," "]})," "]}),m=({label:p,href:g,children:_})=>b.jsxs("a",{href:g,className:"group relative inline-block cursor-pointer py-1",target:g.startsWith("http")?"_blank":"_self",rel:"noopener noreferrer",children:[" ",b.jsxs("div",{className:"flex gap-2 items-center",children:[" ",b.jsx("div",{className:"text-xs text-gray-500 uppercase tracking-widest",children:p})," ",b.jsx("div",{className:"text-gray-300 text-xs",children:_})," "]})," "]});return b.jsxs("section",{id:"contact",className:"min-h-screen text-white relative overflow-hidden",style:{backgroundColor:"#202020"},children:[b.jsx("div",{className:`absolute z-0 \r
                      w-80 h-80 -top-16 -right-20 opacity-50 \r
                      md:w-96 md:h-96 md:top-1/2 md:left-1/2 md:-translate-x-1/2 md:-translate-y-1/2 md:opacity-100`,children:b.jsx("canvas",{ref:s,className:"w-full h-full"})}),b.jsxs("div",{className:"hidden md:flex flex-col justify-between min-h-screen relative z-10",children:[b.jsxs("div",{className:"pt-8",children:[b.jsx("div",{className:"flex justify-center gap-12 md:gap-16 lg:gap-20 mb-8",children:c.map(p=>b.jsx(h,{...p},p.id))}),b.jsx("div",{className:"flex justify-center gap-12 md:gap-16 lg:gap-20",children:f.map(p=>b.jsx(h,{...p},p.id))})]}),b.jsx("div",{className:"flex-grow"}),b.jsxs("div",{children:[b.jsxs("div",{className:"flex justify-between mb-5 max-w-7xl mx-auto px-8",children:[b.jsx(m,{label:"EMAIL",href:"mailto:yooj0264@gmail.com",children:"yooj0264@gmail.com"}),b.jsx(m,{label:"INSTAGRAM",href:"https://instagram.com/yoon664"}),b.jsx(m,{label:"GITHUB",href:"https://github.com/yoon664",children:"https://github.com/yoon664"}),b.jsx(m,{label:"RESUME",href:"#"})]}),b.jsx("div",{className:"w-full mb-4",children:b.jsx("h1",{className:"w-full text-6xl md:text-8xl lg:text-9xl xl:text-[8rem] font-semibold tracking-wider text-gray-400 leading-none opacity-50 text-center",style:{fontFamily:'"Lock Serif Light", serif'},children:"YOOEUNJI WORKS"})}),b.jsx("div",{className:"flex justify-center items-center px-8 pb-4 text-xs text-gray-500",children:b.jsx("div",{className:"opacity-50",children:"© 2025 YOO EUNJI"})})]})]}),b.jsxs("div",{className:"md:hidden flex flex-col min-h-screen p-8 relative z-10",children:[b.jsx("div",{className:"space-y-4",children:[...c,...f].map(p=>b.jsx(h,{...p},p.id))}),b.jsx("div",{className:"flex-grow"}),b.jsxs("div",{className:"w-full flex flex-col items-start space-y-8",children:[b.jsxs("div",{className:"flex flex-col items-start",children:[b.jsx(m,{label:"EMAIL",href:"mailto:yooj0264@gmail.com",children:"yooj0264@gmail.com"}),b.jsx(m,{label:"GITHUB",href:"https://github.com/yoon664",children:"https://github.com/yoon664"}),b.jsx(m,{label:"INSTAGRAM",href:"https://instagram.com/yoon664"}),b.jsx(m,{label:"RESUME",href:"#"})]}),b.jsxs("div",{children:[b.jsx("h1",{className:"text-6xl font-semibold tracking-wider text-gray-400 leading-none opacity-50",style:{fontFamily:'"Lock Serif Light", serif'},children:"YOOEUNJI WORKS"}),b.jsx("p",{className:"mt-4 text-xs text-gray-500 opacity-50",children:"© 2025 YOO EUNJI"})]})]})]})]})},tv={name:"YOO EUNJI",title:"Creative Developer",description:"안녕하세요! ~~~입니다.",email:"yooj0264@gmail.com",phone:"010-5317-1126",github:"https://github.com/yoon664",resume:{education:"Computer, 2021-2025",experience:["Frontend Developer Projects","UI/UX Design Projects"],skills:"React, JavaScript, Photoshop, Illustrator, "}},uR=()=>b.jsxs("div",{className:"text-white font-mono relative",children:[b.jsx(tS,{}),b.jsx(iS,{showPercentage:!1}),b.jsxs("main",{children:[b.jsx(nR,{}),b.jsx(iR,{personalData:tv}),b.jsxs("div",{className:"relative h-[300vh]",children:[b.jsx(aR,{}),b.jsx(rR,{}),b.jsx(sR,{})]}),b.jsx(lR,{}),b.jsx(cR,{personalData:tv})]})]});eS.createRoot(document.getElementById("root")).render(b.jsx(Zt.StrictMode,{children:b.jsx(uR,{})}));export{zM as $,gR as A,hi as B,xt as C,Kc as D,fi as E,bR as F,vR as G,Cv as H,_R as I,xR as J,yR as K,Jo as L,SR as M,lc as N,sn as O,AR as P,Os as Q,rd as R,jn as S,fR as T,Tc as U,Et as V,zn as W,pR as X,Lv as Y,wv as Z,MR as _,dR as a,kc as a0,Ld as a1,Av as a2,Un as a3,Zc as a4,Yc as a5,tu as a6,Rt as a7,Wa as a8,eu as a9,zi as aa,fa as ab,hR as b,RR as c,Ds as d,TR as e,yt as f,K as g,__ as h,ER as i,wR as j,mR as k,Mr as l,hh as m,BS as n,Oi as o,ti as p,sd as q,Sr as r,XM as s,Tr as t,jM as u,WM as v,oa as w,xv as x,Ht as y,ha as z};
